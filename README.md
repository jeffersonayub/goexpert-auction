...
**Classe de teste do fechamento**  
/internal/infra/database/auction/create_auction_test.go

**Para testar se o fechamento está acontecendo de forma automatizada**  
**Excutar o comando no diretório goexpert-auction**  
go test ./internal/infra/database/auction/. -bench=. -run=^#
